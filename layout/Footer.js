        ...
        <div className={styles.inner}>
          ...
          <div className={styles.right}>
            <div className={styles.social}>
              ...
              <ul>
                <a href="https://t.me/BisoSwap" target="_blank">
                  <li className={styles.tg}></li>
                </a>
                <a href="https://twitter.com/bisoswap" target="_blank">
                  <li className={styles.tw}></li>
                </a>
                <a href="https://medium.com/@BisoSwap" target="_blank">
                  <li className={styles.md}></li>
                </a>
                <a href="https://bisoswap.gitbook.io/bisoswap/" target="_blank">
