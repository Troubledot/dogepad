          ...
          <div className={styles.card + ' ' + styles.project}>
            ...
            <div className={styles.info}>
              ...
              <p className={styles.intro}>
                Arkstart is pioneering the new era of BRC-20 token staking with our innovative blockchain project. We
                aim to build a sustainable staking ecosystem using unique staking mechanisms and economic models.
                <br />
                We&apos;ve introduced &apos;arks&apos;, our native token, into an advanced staking feature that brings
                value to BRC-20 tokens. By staking &apos;arks&apos;, users can earn &apos;Aras&apos; tokens as rewards.
                This model incentivizes continuous participation aligning the long-term interests of users with our
                protocol&apos;s objectives.
                <br />
                Our mission is to develop a robust and consistent staking ecosystem, changing the staking paradigm for
                BRC-20 tokens. With our dedicated efforts, we aim to offer greater value and long-term returns to our
                participants.
              </p>
              <div className={styles.contact}>
                ...
                <Link href="https://medium.com/@arkstart" passHref>
                  <a className={styles.item}>
                    <Image src={telegram} alt="telegram" width={23.53} height={20}></Image>
                  </a>
                </Link>
                {/* <Link href="https://www.baidu.com/" passHref>
                  <a className={styles.item}>
                ...
                <Link href="https://medium.com/@arkstart" passHref>
                  <a className={styles.item}>
                    <Image src={meta} alt="meta" width={25.8} height={20}></Image>
                  </a>
                </Link>
              </div>
            </div>
          ...
          <div className={styles.swap}>
            <div className={styles.card + ' ' + styles.item}>
              <div className={styles.title}>
                ...
                <div className={styles.deadline}>
                  <Timer
                    ...
                    initialTime={new Date(1685624400000).getTime() - new Date().getTime()}
                    lastUnit="h"
                    direction="backward"
                  >
                    <ul>
              ...
              <div className={styles.list}>
                ...
                <div className={styles.val + ' ' + styles.ori}>{percentage} %</div>
              </div>
              <div className={styles.amount}>
                <div className={styles.list}>
                  <div className={styles.label}>Total fundraising amount</div>
                  <div className={styles.val + ' ' + styles.ori}>{totalAmount} BTC</div>
                </div>
                <div className={styles.list}>
                ...
                <div className={styles.list}>
                  ...
                  <div className={styles.val + ' ' + styles.ori}>{obtained} $ARKS</div>
                </div>
              </div>
              ...
              <Button
                ...
                renderContent={() => (
                  <>
                    <span className={styles.btnText + ' ' + styles.ori}>Buy</span>
          ...
          <div className={styles.data}>
            <div className={styles.card + ' ' + styles.protocol}>
              <div className={styles.item}>
                ...
                <p>
                  Increased to 80% to provide additional liquidity for initial exchange offerings. This expanded
                  allocation ensures sufficient token availability for IDO/IEO participants, fostering wider
                  participation and enhancing market liquidity.
                </p>
              </div>
              <div className={styles.item}>
                <div className={styles.title}>4% Market Allocation</div>
                <p>
                  Unlocked 20% at Token Generation Event (TGE), primarily used for initial user airdrops, incentives,
                  and ecosystem development. This allocation is adjusted to allocate 7% of the total supply to the
                  market. It enables Arkstart to allocate resources for market development, user acquisition, and
                  ecosystem growth, fostering adoption and establishing a strong presence in the market.
                </p>
              </div>
              <div className={styles.item}>
                <div className={styles.title}>3% Ecosystem and Partnerships</div>
                <p>
                  Allocated for ecosystem development, strategic partnerships, and collaborative initiatives. This
                  allocation ensures 7% of the total supply is dedicated to fostering collaborations with other
                  projects, platforms, and communities. It supports the growth and expansion of the Arkstart ecosystem
                  by integrating complementary services, expanding use cases, and strengthening the overall ecosystem.
                </p>
              </div>
              <div className={styles.item}>
                <div className={styles.title}>10% Staking</div>
                <p>
                  Users can stake the platform token and earn staking rewards. The staking mechanism incentivizes
                  long-term commitment, active participation, and alignment of interests among participants. This
                  allocation ensures 3% of the total supply is dedicated to staking rewards, promoting network security
              ...
              <div className={styles.item}>
                ...
                <p>
                  Reserved for internal and external incentives within the DAO organization. This allocation ensures
                  active governance participation and supports collaborative partnerships, promoting community
            ...
            <div className={styles.other}>
              ...
              <div className={styles.card + ' ' + styles.grayback + ' ' + styles.prompt}>
                ...
                <p>
                  The start-up project is still in its early stages, and there may be significant risks in the operation
                  of the project, the underlying technology of the project, and the legal and regulatory environment.
                </p>
                <p>
                  Understanding tokens and evaluating their inherent risks require advanced technical and financial
                  knowledge.
                </p>
                <p>
                  Due to the influence of technology, laws and regulations, market, and other factors, the price of the
                  token you purchased may fluctuate significantly, and the price may decrease or increase significantly.
                </p>
                <p>
                  Due to the underlying technology of the token or the GATE.IO trading platform, the token you purchased
                  may not be able to be fully or partially withdrawn.
                </p>
              </div>
            </div>
          </div>
